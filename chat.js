...
function firstBotMessage() {
    let firstMessage = "Hey, I'm Kiki BOT. I am fine tuned to answer all of your questions regaring uterine health. So ask away"
...
function getBotResponse(input) {
    ...
    if (typeof input === "string") {
        ...
        if (input.includes("hi") || input.includes("hello") || input.includes("hola") || input.includes("hoi") || input.includes("annyeong") || input.includes("annyeonghaseyo")) {
            ...
            return "PCOS is a hormonal disorder causing irregular periods, ovarian cysts, and potential fertility issues. Lifestyle changes and medication can help manage it.";
        }   else {
